    ...
    namespace higgs_portal_from_kaons {
      dkgen::core::driver::particle_map create_particle_content(double scalar_mass, double theta,
        ...
        ret[std::abs(kaon_pm_pdg)] =
          dkgen::core::particle{kaon_pm_pdg,kaon_pm_mass,kaon_pm_lt}.add_decay({1.,{{pion_pm_pdg,true},{scalar_pdg,false}}}).finalise_decay_table();
        ret[std::abs(kaon_0L_pdg)] =
          dkgen::core::particle{kaon_0L_pdg,kaon_0L_mass,kaon_0L_lt}.add_decay({1.,{{pion_0_pdg,true},{scalar_pdg,false}}}).finalise_decay_table();

        auto& scalar_info = ret[std::abs(scalar_pdg)];

        scalar_info = dkgen::core::particle{scalar_pdg, scalar_mass, scalar_lifetime};
        ...
        ret[std::abs(pion_pm_pdg)] = dkgen::core::particle{pion_pm_pdg,pion_pm_mass,pion_pm_lt};
        ret[std::abs(pion_0_pdg)] = dkgen::core::particle{pion_0_pdg,pion_0_mass,pion_0_lt};
        ret[std::abs(elec_pdg)] = dkgen::core::particle{elec_pdg,elec_mass,elec_lt};
        ret[std::abs(muon_pdg)] = dkgen::core::particle{muon_pdg,muon_mass,muon_lt};
